package cn.edu.bistu.cs.se.wordbook;
...
import cn.edu.bistu.cs.se.wordbook.newsreader.NewsActivity;
...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textViewSearch = (TextView) findViewById(R.id.textSearchActivity);
        tv = (TextView) findViewById(R.id.tv);
        textViewSearch.setOnClickListener(new searchListener());
